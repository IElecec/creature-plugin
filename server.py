...
characters = ["种族","爱吃的食物","天敌","习性","性格","体型","性格","年龄","性别","名字"]
habitats = [
...
async def generate_pet():
    ...
    prompt = f"描述一下用户与它相遇的场景。该物种具有该背景:{habitat}，且该生物且具有以下属性{attribute},且具有以下信息:"+"、".join(characters)+"生成所有的这些信息，但不要告知用户"
...
async def get_information():
    ...
    prompt = f"在开头添加提示语:“异兽终端为您服务！”然后将该个体的所有信息以表格的形式分行列举出来,信息包括："+",".join(characters)
